  ...
  return (
    <div className="bg-black ">
      <div className="h-[100px] max-w-[1200px] mx-auto px-4 flex justify-between items-center ">
        ...
        <ul className="flex gap-x-5 text-[18px] font-semibold max-md:text-[16px] max-sm:hidden">
        ...
        <button className="w-[120px] h-[40px] text-white rounded-tl-[50px] rounded-br-[50px] bg-gradient-to-r from-blue-500 to-purple-600 hover:from-purple-600 hover:to-blue-500 duration-300 cursor-pointer max-sm:hidden">
          <a href="#contact">Contact</a>
        </button>

        <IoMdMenu className="hidden max-sm:block text-[30px] hover:text-blue-700 duration-300 cursor-pointer" />
      </div>
    </div>
  );
};
